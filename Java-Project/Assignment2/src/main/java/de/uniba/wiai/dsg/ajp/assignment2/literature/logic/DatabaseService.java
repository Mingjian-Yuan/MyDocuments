...
public interface DatabaseService {
	 ...
	 *                                     met
	 */
	Database addPublication(String title, int yearPublished, PublicationType type, List<String> authorIDs, String id)
	 ...
	 *                                     met
	 */
	Database removePublicationByID(String id) throws LiteratureDatabaseException;
	 ...
	 *                                     met
	 */
	Database removeAuthorByID(String id) throws LiteratureDatabaseException;
	 ...
	 *                                     met
	 */
	Database addAuthor(String name, String email, String id) throws LiteratureDatabaseException;
