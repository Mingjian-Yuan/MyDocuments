...
public final class SearchTask {
	...
	public SearchTask(String rootFolder, String ignoreFile, String fileExtension, String token, String resultFile) {
		super();
		// Überprüfung
		if (rootFolder !="src/main/resources/data") {
			throw new IllegalArgumentException("Root folder illegal");
		}
		if (ignoreFile !="src/main/resources/ignore.txt") {
			throw new IllegalArgumentException("ignore file illegal");
		}
		if (resultFile !="src/main/resources/output.txt") {
			throw new IllegalArgumentException("result file illegal");
		}
